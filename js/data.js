var dataFields = ["title","titleB","director","award","awardB","description","imgBig","imgSmall","imgMenu","youtubeID","link","mlink","new"];
...
var data = [
    {
        ...
        "titleB" : "戲台滾人生",
        "director" : "XXX",
        "award" : "2016TIDF台灣競賽入圍",
        "awardB" : "TIDF第十屆台灣競賽獎入圍",
        "description" : "苦撐20年的戲班被國家登錄為「重要文化資產保存團體」,喜獲經費補助,但老團長始料未及這竟是技藝失傳的最大危機。",
        "imgBig" : "pic10-poster.png",
        "imgSmall" : "pic10-intro.png",
        "imgMenu" : "pic10-menu.png",
        "youtubeID" : "oDnJMeb4TyQ",
        ...
        "award" : "2016TIDF台灣競賽入圍",
        "awardB" : "TIDF第十屆台灣競賽獎入圍",
        "description" : "1987年台灣解嚴,民主聲浪四起。四年後調查局卻以懲治叛亂條例起訴四位青年,史稱「獨台會案」。本片重現白色恐怖之懼與事件後續。",
        "imgBig" : "pic11-poster.png",
        "imgSmall" : "pic11-intro.png",
        "imgMenu" : "pic11-menu.png",
        "youtubeID" : "6DPfQtKc7J4",
        "link" : "http://video.friday.tw/sn?sn=2016TIDF&button=2016TIDF",
        "mlink" : "http://video.friday.tw/m/sn?sn=2016TIDF&button=2016TIDF",
        "new":true,
    },{
